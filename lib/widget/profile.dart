...
//                 Text(
//                   cardholder.cardholderModel!.firstName ?? '',
//                   style: TextStyle(
//                     color: Colors.white,
//                     fontSize: 28,
...
//         await flutterTts.speak("Selamat Datang ${data.firstName}");
//       }
//     }

//     // Panggil fungsi speak jika eventType adalah 20001
//     if (cardholder.eventType == 20001) {
//       speak();
//     }
...
//     // Jalankan hanya sekali saat init
//     if (widget.cardholder.eventType == 20001) {
//       Future.microtask(() async {
//         await flutterTts.setLanguage("id-ID");
//         await flutterTts.speak(
//             "Selamat Datang ${widget.cardholder.cardholderModel?.firstName ?? ''}");
//       });
//     }
//   }
...
//     const inColor = Color(0xFF4CAF50);
//     const outColor = Color(0xffff6f61);
//     final data = widget.cardholder.cardholderModel!;
//     final doors = POBTracker.readDoor(widget.cardholder.message!);
//     final width = MediaQuery.of(context).size.width;
//     final height = MediaQuery.of(context).size.height;
//     final dateTimeUtc =
//         DateTime.parse(widget.cardholder.occurrenceTime!).toUtc();
...
//               boxShadow: [
//                 BoxShadow(
//                   color: widget.cardholder.eventType! == 20001
//                       ? inColor
//                       : outColor,
//                   blurRadius: 20,
//                   offset: const Offset(0, 5),
...
//                 InfoRow(
//                   icon: Icons.meeting_room,
//                   iconColor: widget.cardholder.eventType! == 20001
//                       ? inColor
//                       : outColor,
//                   label: doors,
//                   labelColor: Colors.white,
